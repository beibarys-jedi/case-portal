package com.company.unicef.test_support;

import com.company.unicef.UnicefApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.unicef.screen")
@ContextConfiguration(classes = {UnicefApplication.class, UiTestAssistConfiguration.class})
